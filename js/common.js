$(document).ready(function() {
	...
	$(document).ready(function () {
 	...
 	var item = document.querySelectorAll('.address i');
 	...
 	for(var i = 0; i < item.length; i++){
 		item[i].onclick = function(){
 			...
 			var index = this.dataset.map;
 			this.classList.add('active');
 			map.setAttribute('src', 'img/map_' + index + '.jpg');
 		}
 	}
...
document.getElementById("seconds"));
	...
	$('.photo img').on('click', function(e){
		$('.photo img').parent().removeClass('active');
	...
	*/
	...
	if ( locale == "ua" ) {
		...
		var validationEmail = "Fill in the correct email";
	}
	else {
